...
|---|---|---|---|---|---|
| 2026-07-16 | [SCHEMA.md](SCHEMA.md) | index | 仓库 Schema(已批总装文书落地):三层结构、episode 状态机、D0–D5、legacy 兼容 | SCHEMA.md | 未同步 |
| 2026-07-16 | [AGENTS.md](AGENTS.md) | index | 仓库规则入口:三层铁律、legacy bundle 边界、锚点合同引用 | AGENTS.md | 未同步 |
...
| 2026-07-16 | [阅读指南](阅读指南.md) | index | Obsidian 阅读通道 A 说明：vault 配置、reading CSS、PC/移动端安装步骤、留言写法 | 阅读指南.md | 本地待验收 |
